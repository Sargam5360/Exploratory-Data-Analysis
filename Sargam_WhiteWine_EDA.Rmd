---
title: "Wine_Exploratory_Data_Analysis"
...
Lets take a look at the histogram for quality:
...
The most common quality rating is 6 with 2198 observations.
...
h1 <- ggplot(aes(x = fixed.acidity), data = wines) +
  geom_histogram() + theme(axis.text = element_blank(), axis.title=element_text(size=9))
...
b1 <- ggplot(aes(x = fixed.acidity), data = wines) +
  geom_histogram(binwidth = 0.1) + theme(axis.text = element_blank(), axis.title=element_text(size=9))
b2 <- ggplot(aes(x = volatile.acidity), data = wines) +
  geom_histogram(binwidth = 0.01) + theme(axis.text = element_blank(), axis.title=element_text(size=9))
b3 <- ggplot(aes(x = citric.acid), data = wines) +
  geom_histogram(binwidth = 0.02) + theme(axis.text = element_blank(), axis.title=element_text(size=9))
b4 <- ggplot(aes(x = residual.sugar), data = wines) +
  geom_histogram(binwidth = 1) + theme(axis.text = element_blank(), axis.title=element_text(size=9))
b5 <- ggplot(aes(x = chlorides), data = wines) +
  geom_histogram(binwidth = 0.005) + theme(axis.text = element_blank(), axis.title=element_text(size=9))
b6 <- ggplot(aes(x = free.sulfur.dioxide), data = wines) +
  geom_histogram(binwidth = 5) + theme(axis.text = element_blank(), axis.title=element_text(size=9))
b7 <- ggplot(aes(x = total.sulfur.dioxide), data = wines) +
  geom_histogram(binwidth = 10) + theme(axis.text = element_blank(), axis.title=element_text(size=9))
b8 <- ggplot(aes(x = density), data = wines) +
  geom_histogram(binwidth = 0.001) + theme(axis.text = element_blank(), axis.title=element_text(size=9))
b9 <- ggplot(aes(x = pH), data = wines) +
  geom_histogram(binwidth = 0.05) + theme(axis.text = element_blank(), axis.title=element_text(size=9))
...
All of the variables follow a normal distribution except for residual sugar. I will use the log transform on the x axis to try to make it look less long-tailed.
...
h4 <- ggplot(aes(x = residual.sugar), data = wines) +
  ...
  geom_histogram(binwidth = 0.05) +
  scale_x_log10()+ theme(axis.text = element_blank(), axis.title=element_text(size=9))
h5 <- ggplot(aes(x = chlorides), data = wines) +
...
I want to take a look at the quality boxplots for each of our variables, while focusing mainly on the correlating variables identified above.


```{r echo=FALSE, warning=FALSE}
#Create a box plot for each variable
qp1 <- qplot(x = quality, y = fixed.acidity, data = wines, 
             geom = 'boxplot') + theme(axis.text = element_blank(), axis.title=element_text(size=9)) 
...
I want to take a look at the box plot and scatter plot for the three variables with the correlation with quality.
...
The last correlation I want to highlight is the correlation between pH and fixed acidity. This correlation makes logical sense because as fixed acidity increases, the pH value becomes more acidic.
